...
\section{Foundations}
    ...
    \subsection{Arnoldi Iterations and Lanczos}
        ...
        \subsubsection{The Lanczos Iterations}
            ...
            \end{proof}
            \begin{remark}
                The characteristic polynomial of $T_k$ minimizes: 
            \end{remark}
...
\section{Analysis of Conjugate Gradient and Lanczos Iterations}
    ...
    \subsection{Termination Conditions of CG}
        ...
        \end{prop}
        This result is direct from (4.1.8), the CG algorithm terminates when a polynomial that interpolates all the unique eigenvalue is found. This bound is true for all initial guess, and sometimes for some given $e_0$, the terminations can come faster than that. 
