    ...
    \subsection{Arnoldi Iterations and Lanczos}
        ...
        \subsubsection{Arnoldi Produces Orthogonal Basis for Krylov Subspace}
            ...
            \begin{remark}[Arnoldi Produces Minimal Monic in Krylov Subspace]\label{remark:Arnoldi_Produces_Minimal_Monic_in_Krylov_Subspace}
                The characteristic polynomial of $H$, minimizes $\Vert p(A|w)q_1\Vert_2$ among all monic polynomials. For more information, Trefethen has a coverage on the topic in his works \cite{book:trefethen}. The minimization property in Arnoldi translate to Lanczos Iterations as well. 
            \end{remark}
