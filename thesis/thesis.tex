...
\section{Effects of Floating-Point Arithmetic}
    ...
    \subsection{Ghost Eigenvalues and Losing Orthogonality}
        ...
        \subsubsection{Losing Orthogonality on Ritz Vectors}
            ...
            \par
            While floating arithematic may sometimes cause the most recent Lanczos vector to loos orthogoality against converged Ritz values, the converse is not true. The phenomena itself doesn't imply the fact that floating point error is presence and it's causing lost of orthogonality of Lanczos iterations. 
            \begin{figure}
                \centering
