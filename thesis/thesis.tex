...
\section{Foundations}
    ...
    \subsection{Subspace Minimization Framework}\label{sec:1.4}
    ...
    \subsection{Deriving Conjugate Gradient from First Principles}
        ...
        \subsubsection{Using the Projector}
            Here, we consider the simple algorithm from (1.8.6). Please observe that $AP_kD_k^{-1}P_k$ is a projector, and so is $P_kD^{-1}_kP_k^TA$. 
            \begin{proof}
                \begin{align}
        ...
        \subsubsection{Residual Assisted Conjugate Gradient}
            ...
            \end{proof}
            \begin{theorem}[Residual Assisted CG Generates Orthogonal Residuals]
                \begin{align}
