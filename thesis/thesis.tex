...
\section{Analysis of Conjugate Gradient and Lanczos Iterations}
    ...
    \subsection{CG Via Lanczos}
        ...
        \begin{align}
            ...
            \end{bmatrix}
        \end{align}
        We consider the LU decomposition of the symmetric tridiagonal matrix: 
        \begin{align}
            T_k = L_k U_k =
            \begin{bmatrix}
                1 & & & \\
        ...
        \begin{remark}
            The derivation might seems out of place for the discussion, but it's part of the analysis of the Conjugate Gradient. The Lanczos algorithm is a special case of Arnoldi when the matrix $A$ is symmetric, drawing a parallel between the FOM algorithm and the above formulation of CG using Lanczos Iterations. 
        \end{remark}
