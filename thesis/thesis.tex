        ...
        \subsubsection{Matching the Residual and Conjugate Vectors}
            ...
            \begin{proof}
                ...
                \begin{align}
                    ...
                    y_k &= T_k^{-1}\beta \xi_1
                \end{align}
                Reader please recall from section \hyperref[sec:CG_and_Krylov_Subspace]{CG and Krylov Subspace} that: $p_k \in \mathcal K_{k + 1}(A|r_0)$, which is implying a link between the $p_k$ A-orthogonal vectors and the Lanczos Orthogonal matrix: $Q_k$. Now to get the residual we simply consider: 
                \begin{align}
                    r_{k + 1} &= r_0 - AQ_k y_k
                    \\
